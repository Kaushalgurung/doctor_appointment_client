...
const Doctors = () => {
    ...
    return (
        <div>
                                ...
                                return (
                                    <tr key={i} >
                                        ...
                                        {is_admin ? (
                                            <>
                                                <td><Button onClick={() => {
                                                    history.push(`${window.location.pathname}/${doctor._id}`);
                                                }}>Edit</Button>
                                                </td>
                                            ...
                                            <>
                                                <td><Button onClick={handleShow}>Book</Button></td>
                                                <td>
                                                    <Button onClick={() => {
                                                        setViewDoctor(doctor);
                                                        handleDetailsShow();
            ...
            <BookDoctor show={show} handleClose={handleClose} handleShow={handleShow} />
            {viewDoctor != new Object() && viewDetails ? (
                <Detail open={viewDetails} doctor={viewDoctor} handleClose={handleDetailsClose} handleOpen={handleDetailsShow} />
            ) : ""}
            {viewDoctor != new Object() && viewDelete? (
                <DeleteDoctor open={viewDelete} id={viewDoctor._id} handleClose={handleDeleteClose} handleOpen={handleDeleteShow} />
            ) : ""}
        </div>
    )
}
